                    ...
                    {person.name ? (
                      <>
                        ...
                        {person.bio.map((para, pi) => (
                          <p key={pi} className="text-[14px] text-[#C2C7D0] leading-[1.9]">
                            {para}
                          </p>
                        ))}
                      </>
                      ...
                      <div className="flex flex-col gap-3">
                        <div className="h-4 w-32 bg-white/[0.04] rounded-sm" />
                        <div className="h-3 w-20 bg-white/[0.03] rounded-sm" />
                        <div className="h-px bg-white/[0.06] w-12 mt-2" />
                        <div className="flex flex-col gap-2 mt-1">
                          <div className="h-3 w-full bg-white/[0.03] rounded-sm" />
                          <div className="h-3 w-5/6 bg-white/[0.03] rounded-sm" />
                          <div className="h-3 w-4/6 bg-white/[0.03] rounded-sm" />
                        </div>
                      </div>
                    )}
                  </div>
